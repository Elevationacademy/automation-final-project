class Login {
    ...
    async login() {
        ...
        await this.selenium.write("xpath", "//*[@name='user-name']/child::div/child::input", this.userName);
        await this.selenium.write("xpath", "//*[@name='password']/child::div/child::input", this.password);
